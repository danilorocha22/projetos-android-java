package com.danilorocha.pdm2.ui.esporte;
...
public class EsportesFragment extends Fragment {
    ...
    private static final String RESPOSTA_CERTA = "Polo Aquatico",
            ...
            public void onClick(View view) {
                switch (ct) {
                    case 0:
                        ...
                        imgViewDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.pscina));
                    ...
                    case 1:
                        ...
                        imgViewDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.bola_polo));
                        btnResposta.setOnClickListener(avaliarResposta(editTextResposta, ct));
                        break;

                    case 2:
                        imgViewTituloDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.terceira_dica));
                        imgViewDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.polo));
                        btnResposta.setOnClickListener(avaliarResposta(editTextResposta, ct));
                        btnVerDica.setVisibility(View.INVISIBLE);
                        break;
                }
