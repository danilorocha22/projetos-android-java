package com.danilorocha.pdm2.ui.livro;
...
public class LivrosFragment extends Fragment {
    ...
    private static final String RESPOSTA_CERTA = "Harry Potter",
            ...
            public void onClick(View view) {
                switch (ct) {
                    case 0:
                        ...
                        imgViewDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.gryffinoria));
                    ...
                    case 1:
                        ...
                        imgViewDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.coruja));
                        btnResposta.setOnClickListener(avaliarResposta(editTextResposta, ct));
                        break;

                    case 2:
                        imgViewTituloDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.terceira_dica));
                        imgViewDica.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.varinha));
                        btnResposta.setOnClickListener(avaliarResposta(editTextResposta, ct));
                        btnVerDica.setVisibility(View.INVISIBLE);
                        break;
                }
