...
public class DescricaoAdapter extends RecyclerView.Adapter<DescricaoAdapter.MyViewHolder> {
    private List<Descricao> lista;
    private View.OnClickListener onClickListener;

    public DescricaoAdapter(List<Descricao> lista) {
        this.lista = lista;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull DescricaoAdapter.MyViewHolder holder, int position) {
